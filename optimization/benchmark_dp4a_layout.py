...
def main():
    ...
    outfile=RESULTS/f'dp4a_layout_kernels_{args.tag}.json';assert not outfile.exists(),'Preserve old results'
    ...
    for name in ('qkv','out','up','down'):
        ...
        actual=aa=bb=None
        configs=[{'rows':r,'warps':nw,'integer_groups':ig,'integer_rows':ir} for r,nw in ([(32,4),(32,8)] if name=='up' else [(4,2),(4,4),(8,4),(8,8)]) for ig in (1,2,4) for ir in (1,nw)]
