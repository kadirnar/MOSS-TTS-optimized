...
def project(module,name,x,prequantized=None):
    ...
    if name in getattr(module,'_group128_plan',{}):
        from .dp4a_group128 import project as group128_project
        return group128_project(module,name,x,prequantized)
    cfg=module._dp4a_packing[name]
    if name=='out' and getattr(module,'_native_output',False):
        from .dp4a_output_native import linear as native_output
        return native_output(x,module._quant_out,module._quant_out_scale,prequantized=prequantized)
