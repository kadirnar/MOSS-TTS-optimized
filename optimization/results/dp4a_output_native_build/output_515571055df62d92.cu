...
extern "C" int launch_output_native(void* q,void* xs,void* w,void* s,void* y,int n,void* stream){
    return run<4096,false,false,4,8>(q,xs,w,s,y,nullptr,nullptr,n,stream);
}
