...
def main():
    ...
    p.add_argument('--frames',type=int,default=140);p.add_argument('--runs',type=int,default=3);a=p.parse_args()
    ...
    for name,options in (('control',None),('clock',{'first_frame':False}),('first',{'first_frame':True}),('kv_first',{'first_frame':True,'kv_only':True})):
        ...
        # Separate first/steady profile, excluded from reported timings.
        decoder.reset()
