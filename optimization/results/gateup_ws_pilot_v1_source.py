...
@gluon.jit
def _worker(X,RES,NW,W,S,SUM,Y,OQ,OS,buffer,ready,N:gl.constexpr,EPS:gl.constexpr,MODE:gl.constexpr):
...
@gluon.jit
def _default(X,RES,NW,W,S,SUM,Y,OQ,OS,buffer,ready,N:gl.constexpr,EPS:gl.constexpr,MODE:gl.constexpr):
...
def _kernel(X,RES,NW,W,S,SUM,Y,OQ,OS,N:gl.constexpr,EPS:gl.constexpr,MODE:gl.constexpr,WORKER_REGS:gl.constexpr):
    ...
    args=(X,RES,NW,W,S,SUM,Y,OQ,OS,buffer,ready,N,EPS,MODE)
