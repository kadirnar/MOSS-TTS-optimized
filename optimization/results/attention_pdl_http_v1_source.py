...
def main():
    ...
    result={'method':'Sequential temporary servers, qualified projection PDL control then attention PDL with Q/K norm preloads; identical text/reference/seeds 501-520, all 32 codebooks. No concurrent GPU test.','all_20_full_pcm_streams_exact':same,
