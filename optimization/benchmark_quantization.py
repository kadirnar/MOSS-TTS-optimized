...
def main():
    ...
    if args.attention_history and not args.gateup_compiler:raise ValueError('Historical attention preloads require the selected gate/up compiler preset')
    ...
    attention_history_config=None
    if args.attention_history:
        from .attention_history_model import enable
        attention_history_config=enable(engine.llm)
    ...
    if args.attention_history:name+='_ahist'
    ...
    result = {
        ...
        'output_weight_prefetch':output_weight_prefetch_config,'qkv_cluster':qkv_cluster_config,'down_tile8':down_tile8_config,'gateup_compiler':gateup_compiler_config,'attention_history':attention_history_config,
